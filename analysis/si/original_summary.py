...
def print_gait_report(result, return_str=False):
    ...
    left_pressure = result.get('pressure_left', {})
    right_pressure = result.get('pressure_right', {})
    ...
    left_counts = left_fc.get('counts', {})
    right_counts = right_fc.get('counts', {})
    left_pcts = left_fc.get('percentages', {})
    right_pcts = right_fc.get('percentages', {})
